...
public class UserPositionService {
    ...
    private Position getPosition(Integer id) {
        if (id == null) throw new IllegalArgumentException("Position ID must not be null");
    ...
    public UserPosition findById(Integer id) {
        return repository.findById(id)
            .orElseThrow(() -> new IllegalArgumentException("UserPosition not found: " + id));
    }
    ...
    public UserPosition update(Integer id, UserPositionDTO dto) {
        ...
        if (dto.getPositionId() != null) up.setPosition(getPosition(dto.getPositionId()));
